...
if platform.system() == 'Darwin':
    flags += [
        ...
        # Homebrew g++ 7.3.0 @ Mac OS X
        '-isystem',
        '/usr/local/opt/gcc/include/c++/7.3.0',
        '-isystem',
        '/usr/local/opt/gcc/include/c++/7.3.0/x86_64-apple-darwin17.4.0',
        '-isystem',
        '/usr/local/opt/gcc/include/c++/7.3.0/backward',
        '-isystem',
        '/usr/local/opt/gcc/lib/gcc/7/gcc/x86_64-apple-darwin17.4.0/7.3.0/include',
        '-isystem',
        '/usr/local/opt/gcc/lib/gcc/7/gcc/x86_64-apple-darwin17.4.0/7.3.0/include-fixed',
        '-isystem',
